...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 CardDAV DELETE returns 204, removes the contact from all CardDAV responses, and changes getctag
- [x] #2 The web UI has a Trash section listing trashed contacts with their deletion time
- [ ] #3 Restoring a contact returns it to the main list and to devices on their next refresh
- [x] #4 Trashed contacts are excluded from the main list and search
- [x] #5 DELETE on an archived contact is a 404 (devices cannot see archived contacts)
<!-- AC:END -->
